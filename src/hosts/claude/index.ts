// The Claude Code host. Public surface for the installer and the eventual
// `token-norm hook <host> <event>` CLI (build order step 7); the policy itself
